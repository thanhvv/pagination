<?php
add_action( 'admin_menu', 'paginationmenu' );
...
{
    echo '<p class="breaking_info">' . __( 'Phân trang cho wordpress sử dụng shortcode.', 'paginationgg' ) . '</p>';
}

function pagination_settings_section_info() 
{
    echo '<div class="paginationgg-info">';
    echo '<p><strong>Hướng dẫn sử dụng Shortcodes:</strong><br /><em>' . __( '[paginationgg]' ) . '</em></p>';
    echo '</div>';
}
